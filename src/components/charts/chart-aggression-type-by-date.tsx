...
const ChartAggressionTypeByDate = ({chartData}: ChartAggressionTypeByDateProps) => {
        ...
        <Card>
            <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
                <div className="grid flex-1 gap-1 text-center sm:text-left">
                    <CardTitle>Resumen de agresiones</CardTitle>
                    <CardDescription>
                        Mostrando la cantidad de agresiones por tipo de agresión de los últimos 3 meses.
                    </CardDescription>
                </div>
